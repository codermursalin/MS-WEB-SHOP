...
export const adminUpdateUserDetails =
  (userData) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(
        `/api/user/admin/users/edit/${userData.id}`,
        userData,
        config
      );
      dispatch({
...
export const UserList = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get("/api/user/admin/users", config);
    dispatch({
...
export const DeleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `/api/user/admin/users/remove/${id}`,
      config
    );
    dispatch({
